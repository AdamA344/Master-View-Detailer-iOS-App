...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    func insertNewObject(_ sender: Any) {
        ...
        newAssessment.assessmentName = "Mobile Native Development"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let title = self.fetchedResultsController.fetchedObjects?[indexPath.row].assessmentName
        let module = self.fetchedResultsController.fetchedObjects?[indexPath.row].moduleName
        cell.cellAssessmentName.text = title
        cell.cellModuleName.text = module
    ...
    //assign labels to the data stored in the database
